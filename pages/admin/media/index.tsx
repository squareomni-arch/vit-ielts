            ...
            <div style={{ padding: "8px 10px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Space size={2}>
                        ...
                        <Popconfirm title="Xóa file này?" description="File sẽ bị xóa vĩnh viễn khỏi bucket Supabase." onConfirm={() => onDelete(item.id)}>
        ...
        },
        {
            ...
            render: (_, r) => (
                <Space size="small">
                    ...
                    <Popconfirm title="Xóa file này?" description="File sẽ bị xóa vĩnh viễn khỏi bucket Supabase." onConfirm={() => handleDelete(r.id)}>
