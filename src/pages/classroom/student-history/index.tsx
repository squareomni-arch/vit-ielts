...
import { getClassroom, getStudentHistory } from "~services/classroom";
import { ROUTES } from "@/shared/routes";

export { PageStudentHistory } from "./ui";
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const [master, result, history] = await Promise.all([
    getMasterData(context),
    getClassroom(supabase, classroomId),
    getStudentHistory(supabase, classroomId, studentId),
  ]);
