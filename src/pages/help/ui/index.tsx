...
const POPULAR_QUESTIONS = [
  ...
  // Technical Issues (Category: technical)
  {
    ...
    answer: "Nếu quá trình xử lý giao dịch gặp trục trặc hoặc bạn cần báo cáo sự cố thanh toán, vui lòng liên hệ ngay qua Hotline hỗ trợ nhanh: 0703 817 013 để được đội ngũ kỹ thuật hỗ trợ đối soát kịp thời."
  },
  {
    id: "q24",
    category: "technical",
