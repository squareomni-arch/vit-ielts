...
export const getServerSideProps: GetServerSideProps = withMultipleWrapper(
  ...
  async (context: GetServerSidePropsContext) => {
    ...
    const [
      ...
      getQuizzes(supabase, { type: "academic", pageSize: 8 }).catch(() => ({ data: [] as Quiz[], count: 0 })),
      getQuizzes(supabase, { type: "general", pageSize: 8 }).catch(() => ({ data: [] as Quiz[], count: 0 })),
    ...
    return {
      props: {
        ...
        academicQuizzes: academicQuizzesRes.data,
        generalQuizzes: generalQuizzesRes.data,
        ...
        academicCount: academicQuizzesRes.count || 0,
        generalCount: generalQuizzesRes.count || 0,
