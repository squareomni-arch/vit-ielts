      ...
      <div className="min-h-screen pb-20 bg-white relative px-4 sm:px-6">
        ...
        <Container className="max-w-[1360px] relative z-10">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {/* Right Column: Related essays */}
            <div className="w-full lg:w-[280px] shrink-0 space-y-6 relative z-10">
              {relatedEssays.length > 0 && (
                <div className="sticky top-8 space-y-4">
                  <h3 className="font-bold text-lg text-[#2D3142]">Bài viết liên quan</h3>
                  <div className="space-y-4">
                    {relatedEssays.slice(0, 4).map((essay) => (
                      <TestCard
                        key={essay.id}
